...
# 4.✅ to Flask() add the following arguments static_url_path='',static_folder='../client/build', template_folder='../client/build'
app = Flask(
    __name__, 
    static_url_path='',
...
# 3.✅ set ['SQLALCHEMY_DATABASE_URI'] to  os.environ.get('DATABASE_URI')
...
# 5.✅ Add in routes to handle Client side routing
@app.route('/')
@app.route('/<int:id>')
def index(id=0):
